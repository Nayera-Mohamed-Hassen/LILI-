...
class CreateNewExpensesPage extends StatefulWidget {
  @override
  _CreateNewExpensesPageState createState() => _CreateNewExpensesPageState();
}

class _CreateNewExpensesPageState extends State<CreateNewExpensesPage> {
